  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="group-hover/sidebar:translate-x-1 inline-block whitespace-pre !p-0 !m-0 text-sm text-neutral-700 transition duration-150 dark:text-neutral-200"
      >
        {link.label}
      </motion.span>
    </Link>
